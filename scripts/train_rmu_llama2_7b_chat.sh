...
# Full training script for RMU on the local llama2 harmbench JSON dataset.
# Uses 4 GPUs + ZeRO-3 optimizer CPU offload + flash attention + adamw_torch by default.
...
ACCELERATE_CONFIG="${ACCELERATE_CONFIG:-configs/accelerate/default_config_4gpu_zero3_offload_optimizer.yaml}"
