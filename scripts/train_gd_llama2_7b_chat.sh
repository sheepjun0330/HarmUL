...
# Full training script for GradDiff on the local llama2 harmbench JSON dataset.
# Uses 4 GPUs + ZeRO-3 by default because 2 GPUs OOM'd in verification.
...
ACCELERATE_CONFIG="${ACCELERATE_CONFIG:-configs/accelerate/default_config_4gpu_zero3.yaml}"
