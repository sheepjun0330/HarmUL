...
# Run unlearning methods on local JSONL datasets for Llama-2-7b-chat-hf.
# You can override defaults with env vars, and pass extra Hydra overrides as args.
#
# Examples:
#   uv run bash scripts/json_unlearn_llama2_7b_chat.sh
#   METHODS="GA,GD,NPO" uv run bash scripts/json_unlearn_llama2_7b_chat.sh --dry-run
